    ...
    <div className="mt-4">
      <form onSubmit={onSubmit} className="space-y-4">
        <div className="flex flex-col items-left space-x-2">
          ...
          <input value={gameId} onChange={(e) => setGameId(Number(e.target.value))} placeholder="Game ID" type="number" min="0" required className="w-full p-2 border border-gray-300 rounded" />
        </div>
