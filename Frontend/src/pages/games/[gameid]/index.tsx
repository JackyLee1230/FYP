        ...
        >
          ...
          >
            <Divider textAlign="left" flexItem={true}>
              <Tooltip
                title={
                  "The Aggregated Review is a review generated by our large language model based on the user reviews."
                }
              >
                <Box
                  sx={{
            ...
            > 
              {game?.aggregatedReview ? (
                <>
                  ...
                  >
                    {`Last Updated: ${game?.aggregatedReviewUpdatedAt ? format(new Date(game?.aggregatedReviewUpdatedAt), "yyyy-MM-dd") : "Unknown"}`}
                  </Typography>
                </>
              ):(
                <Typography
