...
import { Box, Typography, Divider, Avatar, styled, Button } from "@mui/material";
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <Typography variant="h5" sx={{ fontWeight: 700, textShadow: "0px 4px 4px rgba(0, 0, 0, 0.25)", width: "100%", textAlign: "center"}} color="white">
          ...
          >
            ...
            >
              <Typography variant="subtitle2" color="text.secondary">
                {review?.playTime != null ? `${review?.playTime} hours,` : "Unknown hours,"}
              </Typography>
              <Typography variant="subtitle2" color="text.secondary">
                {review?.platform != null ? `Platform: ${getPlatform(review?.platform)},` : "Platform: Unknown,"}
              </Typography>
              <Typography variant="subtitle2" color="text.secondary">
                {review?.gameVersion != null ? `Version: ${review?.gameVersion}` : "Version: Unknown"}
              </Typography>
            </Box>
            <Button 
              variant="outlined" 
