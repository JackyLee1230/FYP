...
const AdvancedSearchBox = ({ setOpen }: AdvancedSearchBoxProps) => {
  ...
  const handleSearchTypeChange = (
    event: SelectChangeEvent<"game" | "developer">
  ) => {
    setSearchType(event.target.value as "game" | "developer");
  };

  const handleIsInDevelopmentChange = (
          ...
          <FormControl>
            ...
            >
              ...
              <FormControlLabel
                value="true"
                control={<Radio />}
                label="Show Games In Development"
              />
              <FormControlLabel
                value="false"
                control={<Radio />}
                label="Exclude Games In Development"
              />
            </RadioGroup>
          </FormControl>
        </Box>
