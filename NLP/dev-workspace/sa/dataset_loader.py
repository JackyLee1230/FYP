...
def load_presampled_dataset(dataset_size:int, is_balanced:bool):
    '''Load pre-sampled dataset from NLP/dev-workspace/dataset/sa/sampled_{dataset_size}k_2023-12-16/
    ...
    Returns:
        dataset_traintest (pd.DataFrame): training and testing dataset
    ...
    return dataset_traintest, X_imbal_valid, y_imbal_valid, X_bal_valid, y_bal_valid

def create_traintest_dataset(dataset_traintest:pd.DataFrame):
