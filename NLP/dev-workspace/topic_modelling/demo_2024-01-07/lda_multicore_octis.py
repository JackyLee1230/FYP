...
class LDAMulticoreOctis(AbstractModel):
    ...
    def __init__(
        self, corpus=None, num_topics=100, id2word=None, workers=None, chunksize=2000, 
        ...
        """
        Initialize LDA Multicore model (from Gensim)

        Parameters
        ----------
        corpus (iterable of list of (int, float), optional) – Stream of document
        vectors or sparse matrix of shape (num_documents, num_terms).
        ...
        If None all available cores (as estimated by workers=cpu_count()-1 will be used. Note however that for hyper-threaded CPUs, this estimation returns a too high number – 
        ...
        self.hyperparameters['corpus'] = corpus
        self.hyperparameters["num_topics"] = num_topics
        self.hyperparameters['id2word'] = id2word
        ...
        self.hyperparameters['dtype'] = dtype
    ...
    def train_model(self, dataset, hyperparams=None, top_words=10):
        ...
        # must keep the dataset object for optimizer
        ...
        self.trained_model = ldamulticore.LdaMulticore(**self.hyperparameters)

        result = {}

        result["topic-word-matrix"] = self.trained_model.get_topics()

        # TODO: overwrite the methods to get topic-doc matruix, and topic-word matrix
